  ...
  return (
    <header className="pl-4 pr-4">
      <div className="py-4 flex justify-between items-center">
        ...
        <a className="flex items-center border-solid border-2 border-orange-500 bg-orange-500 text-white px-4 py-2 rounded-full transition-colors duration-500 hover:border-gray-700 hover:bg-gray-700" href="#address">
